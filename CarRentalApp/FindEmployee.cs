...
namespace CarRentalApp
{
    public partial class FindEmployee : Form
    {
        ...
        private void customerIDSearchButton_Click(object sender, EventArgs e)
        {
            ...
            {
                employeeIDResultLabel.Text = "Running the query . . . ";
                employeeIDResultLabel.ForeColor = Color.FromArgb(0, 192, 0); //dark green
                // run query
            }
        ...
        private void sinSearchButton_Click(object sender, EventArgs e)
        {
            ...
            {
                sinResultLabel.Text = "Running the query . . . ";
                sinResultLabel.ForeColor = Color.FromArgb(0, 192, 0); //dark green
                // run query
            }
        }
        /*
