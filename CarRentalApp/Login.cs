...
namespace CarRentalApp
{
    internal class Login
    {
        ...
        public static bool insertCustomer(Customer cx)
        {
            ...
            string sql = "INSERT INTO Customer (First_Name, Last_Name, Phone_Number, Email, Birthday, Insurance_Policy_Number, Drivers_License, Password, Street_Address, City, Province, Country, Membership_Status, Card_Number, Card_Type) ";
            string values = "VALUES (@fname, @lname, @phone, @email, @bday, @insurance, @license, @password, @address, @city, @province, @country, @status, @cardno, @cardtype);";
            ...
            using (SqlCommand command = new SqlCommand(insertvals, connection))
            {
                ...
                command.Parameters.Add("@cardno", SqlDbType.VarChar).Value = cx.CardNumber;
                command.Parameters.Add("@cardtype", SqlDbType.VarChar).Value = cx.CardType;
